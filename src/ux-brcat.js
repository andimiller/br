...
async function startParsing( )
{
  ...
  const killmails = [].concat(...await Promise.all(zkillmails.map(k => fetch("https://esi.evetech.net/v1/killmails/"+k.killmail_id+"/"+k.zkb.hash+"?"+useragent).then(function (b) { return b.json().then(function (b2) { return Object.assign(k, b2); })}))));
